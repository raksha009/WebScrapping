...
function processScorecard(url) {
    request(url, cb);   // cb is call back function called
}
...
function extractMatchDetails(html) {
    ...
    // ipl folder --> team names folder ---> player's workbook --->has in worksheet: runs balls fours sixes sr opponent venue date  result
    // venue date 
    // .event .description
...
function processPlayer(teamName, playerName, runs, balls, fours, sixes, sr, opponentName, venue, date, result) {
    ...
    let playerObj = {
        teamName,     // "teamName" : teamName shorthands to teamName
        playerName,
        runs,
        balls,
        fours,
    ...
    // Write in excel sheet --- setting name of the excelsheet as respective playerName
...
function excelWriter(filePath, json, sheetName) {
    ...
    // Create excel file (via xlsx module)
